...
## Latest release: v0.30.1 (2026-07-06)
...
> review via MRA protocol v1 (unreleased on `main`) — the
> [changelog](https://hanfour.github.io/pm-workspace-kit/docs/changelog) is
> authoritative. Tests: **1,117** across all workspaces (`cli` 1009 · `core` 50 ·
> `shared` 32 · `rag` 13 · `desktop` 13), on `main` past v0.30.1.
