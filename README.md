...
## Latest release: v0.32.0 (2026-07-17)
...
> atom with KB-wide injection defense (v0.28–v0.29), the `:cr:` / `:a:`
> review-and-approve flow with a live progress bar (v0.30), and Codex-provider
> review via MRA protocol v1 (v0.31), and the live-verified `:a:` GitHub
> approve behind a cross-process authorization lock (v0.32) — the
> [changelog](https://hanfour.github.io/pm-workspace-kit/docs/changelog) is
> authoritative. Tests: **1,134** across all workspaces (`cli` 1026 · `core` 50 ·
> `shared` 32 · `rag` 13 · `desktop` 13), at v0.32.0.
