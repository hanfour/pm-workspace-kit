...
- **Week 1** — Stand up the Slack gateway against one channel ([onboarding guide](./gateway/lifecycle.md), once shipped: `pmk gateway doctor` + `--dry-run`). Seed your existing PKB.
