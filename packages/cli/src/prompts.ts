 ...
 *
 * Every prompt begins with BASE_RULES so the model behaves as a plain
 * text assistant even when run through the Claude Agent SDK (which
 * otherwise encourages agent/tool/skill framing).
 */
