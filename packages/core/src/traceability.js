...
function cmdMatrix() {
  ...
  // No generation-date stamp: it is the only volatile field in the output and
  // made the traceability-check CI diff flaky (any PR touching this script on a
  // later day failed purely on the date line). Git history records when the
  // committed matrix last changed.
  sections.push("");
